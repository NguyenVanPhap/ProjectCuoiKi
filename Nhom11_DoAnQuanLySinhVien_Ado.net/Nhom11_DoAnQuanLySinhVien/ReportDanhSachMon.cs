...
namespace Nhom11_DoAnQuanLySinhVien
{
    public partial class ReportDanhSachMon : Form
    {
        ...
        {
            // TODO: This line of code loads data into the 'QuanLyDiemSinhVien.Lop' table. You can move, or remove it, as needed.
            this.MonHocTableAdapter.Fill(this.QuanLyDiemSinhVien.MonHoc);
        ...
        private void btnTimKiem_Click(object sender, EventArgs e)
        {
            ...
            {
                this.MonHocTableAdapter.FillByMaMon(this.QuanLyDiemSinhVien.MonHoc, this.cbbMaMon.Text);
